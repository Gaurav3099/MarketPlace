...
<?php
    $result = $conn->query("SELECT * FROM Products where productId = 62");
    $prod = $result -> fetch_assoc();
    $hits = $prod["productHits"] + 1;
    $conn->query("UPDATE Products SET productHits = ".$hits." WHERE productId = 62");    
    //$conn->close();
?>
...
<body class="drawingPage">
    ...
    <div class="topContainer">
        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-item active">
                <img src="../img/s23.jpeg" alt="Drawing1" class="d-block" style="width:100%">
            </div>
    ...
    <div class="containerHeader">
        ...
        <?php 
            $sql = "SELECT * FROM Products WHERE productID = 62";
        ...
        <?php 
            $sql = "SELECT * FROM Ratings WHERE productID = 62";
            $result = mysqli_query($conn, $sql);
            $rows = mysqli_num_rows($result);
            if($rows > 0)
            {
