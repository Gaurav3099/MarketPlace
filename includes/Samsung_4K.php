...
<?php
    $result = $conn->query("SELECT * FROM Products where productId = 64");
    $prod = $result -> fetch_assoc();
    $hits = $prod["productHits"] + 1;
    $conn->query("UPDATE Products SET productHits = ".$hits." WHERE productId = 64");    
    //$conn->close();
?>
...
<body class="drawingPage">
    ...
    <div class="topContainer">
        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-item active">
                <img src="../img/tv.jpeg" alt="Drawing1" class="d-block" style="width:100%">
            </div>
        ...
        <div class="longDescContainer">
            <h4 class="Desctext">Samsung 4K TV</h4>
            <p class="longDesc">
                Enhance your viewing experience with this 70-inch Samsung 4K UHD smart TV.
                The HDR technology and 4K UHD resolution render sharp details and realistic colors, while a Crystal processor delivers exceptional picture quality on the flat-panel display.This Bluetooth-enabled Samsung 4K UHD smart TV is voice controllable for hands-free operation and seamless wireless streaming.
    ...
    <div class="containerHeader">
        ...
        <?php 
            $sql = "SELECT * FROM Products WHERE productID = 64";
        ...
        <?php 
            $sql = "SELECT * FROM Ratings WHERE productID = 64";
            $result = mysqli_query($conn, $sql);
            $rows = mysqli_num_rows($result);
            if($rows > 0)
            {
