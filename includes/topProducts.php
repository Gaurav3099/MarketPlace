...
<!-- Happy Buy -->
<!-- The Modal -->
<div class="modal fade modal-xl" id="MostVisHappyBuyModal">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">

      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Most Visited Products in the Happy Buy</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      ...
      <div class="modal-body container">
        <?php
            $sql = "SELECT * FROM Products WHERE productCompany = 'S' ORDER BY productHits DESC";
            $results = $conn->query($sql);
            echo "<div class='row'>\n"; 
            for($i=0; $i<5; $i++)
            {
...
<!-- Furniture -->
<!-- The Modal -->
<div class="modal fade modal-xl" id="MostVisfurnModal">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">

      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Most Visited Products in the The Furniture Store</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      ...
      <div class="modal-body container">
        <?php
            $sql = "SELECT * FROM Products WHERE productCompany = 'G' ORDER BY productHits DESC";
            $results = $conn->query($sql);
            echo "<div class='row'>\n"; 
            for($i=0; $i<5; $i++)
            {
...
<!-- Happy Buy -->
<!-- The Modal -->
<div class="modal fade modal-xl" id="MostRevHappyBuyModal">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">

      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Most Reviewed Products in the Happy Buy</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      ...
      <div class="modal-body container">
        <?php
            $sql = "SELECT * FROM Products WHERE productCompany = 'S' ORDER BY productReviewCount DESC";
            $results = $conn->query($sql);
            echo "<div class='row'>\n"; 
            for($i=0; $i<5; $i++)
            {
...
<!-- Furniture -->
<!-- The Modal -->
<div class="modal fade modal-xl" id="MostRevFurnModal">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">

      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Most Reviewed Products in the Furniture Store</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      ...
      <div class="modal-body container">
        <?php
            $sql = "SELECT * FROM Products WHERE productCompany = 'G' ORDER BY productReviewCount DESC";
            $results = $conn->query($sql);
            echo "<div class='row'>\n"; 
            for($i=0; $i<5; $i++)
            {
...
<!-- Furniture -->
<!-- The Modal -->
<div class="modal fade modal-xl" id="MostRatFurnModal">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">

      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Highly Rated Products in the Furniture Store</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      ...
      <div class="modal-body container">
        <?php
            $sql = "SELECT * FROM Products WHERE productCompany = 'G' ORDER BY productAvgRating DESC";
            $results = $conn->query($sql);
            echo "<div class='row'>\n"; 
            for($i=0; $i<5; $i++)
            {
...
<!-- Happy Buy -->
<!-- The Modal -->
<div class="modal fade modal-xl" id="MostRatHappyBuyModal">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">

      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Highly Rated Products in Happy Buy</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      ...
      <div class="modal-body container">
        <?php
            $sql = "SELECT * FROM Products WHERE productCompany = 'S' ORDER BY productAvgRating DESC";
            $results = $conn->query($sql);
            echo "<div class='row'>\n"; 
            for($i=0; $i<5; $i++)
            {
