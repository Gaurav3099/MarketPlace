...
<?php
    $result = $conn->query("SELECT * FROM Products where productId = 57");
    $prod = $result -> fetch_assoc();
    $hits = $prod["productHits"] + 1;
    $conn->query("UPDATE Products SET productHits = ".$hits." WHERE productId = 57");    
    //$conn->close();
?>
<?php 
...
<head>
    ...
    <title>Chair with Arm Rest | Furniture Store</title>
</head>
<body class="parisPage">
    ...
    <div class="topContainer">
        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-item active">
                <img src="../img/slider2.png" alt="1_paris" class="d-block" style="width:100%">
        ...
        <div class="longDescContainer">
            ...
            <p class="longDesc">
            A chair with armrests for added comfort and support.
            <br>
            <br>
            A chair with armrests is a type of seating that features additional support for the arms and shoulders. These chairs come in a variety of styles and materials, with options to fit any decor style. The added armrests provide a comfortable place to rest the arms, making these chairs ideal for relaxing
            </p>
        </div>
    </div>
    ...
    <div class="bottomContainer">
        <div class="containerHeader">
            ...
            <?php 
                $sql = "SELECT * FROM Products WHERE productID = 57";
        ...
        <?php 
            $sql = "SELECT * FROM Ratings WHERE productID = 57";
            $result = mysqli_query($conn, $sql);
            $rows = mysqli_num_rows($result);
            if($rows > 0)
            {
