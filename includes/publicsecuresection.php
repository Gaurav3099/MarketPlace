...
<body class="psecurePage">
    ...
    <div class="loginHomePage">
        ...
        <div class="homebtnsContainer">
            ...
            <a class='loginHomeBtn3 animate__animated animate__zoomIn animate__delay-1' data-bs-toggle='modal' data-bs-target='#top5FurnModal'>Your Top 5 in The Furniture Store</a>
            ...
            <a class='loginHomeBtn3 animate__animated animate__zoomIn animate__delay-1' data-bs-toggle='modal' data-bs-target='#top5HappyBuyModal'>Your Top 5 in HappyBuy</a>
        </div>
    </div>
    <script>
        setTimeout(function () {
    ...
    <!-- The Modal -->
    <div class="modal fade modal-xl" id="top5HappyBuyModal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Top 5 Most Visited Products in HappyBuy</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
    ...
    <!-- Furniture Store -->
    <!-- The Modal -->
    <div class="modal fade modal-xl" id="top5FurnModal">
    <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Top 5 Most Visited Products in Furniture Sore</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
