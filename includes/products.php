    ...
    <div class="sidebar" id="side_nav">
        ...
        <div class="sidebarContent sideNavActive">
            ...
            <ul class="dropdown-menu1 list-unstyled">
                ...
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostVisFurnModal'>Most Visited the Furniture Store</a></li>
                ...
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostVisHappyBuyModal'>Most Visited in Happy Buy</a></li>
                <hr class="mx-3">
                ...
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostRevFurnModal'>Most Reviewed in The Furniture Store</a></li>
                ...
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostRevHappyBuyModal'>Most Reviewed in Happy Buy</a></li>
                <hr class="mx-3">
                ...
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostRatFurnModal'>Highly Rated in the Furniture Store</a></li>
                ...
                <li class="itemList"><a class="item" data-bs-toggle='modal' data-bs-target='#MostRatHappyBuyModal'>Highly Rated in Happy Buy</a></li>
            </ul>
        </div>
    </div>
